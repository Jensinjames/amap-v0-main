...
import { CheckCircle, XCircle, Database, RefreshCw, Play, FileText, Settings } from "lucide-react"
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Check and troubleshoot database setup issues
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="flex items-center space-x-2">
              {databaseCheck ? getStatusIcon(databaseCheck.success) : (
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center space-x-2">
              {databaseCheck ? getStatusIcon(databaseCheck.functionsAvailable || false) : (
